...
vodka = IngredientService.addIngredient(name="Vodka", pumpNumber=0, size="1.75 L", ml=1750, brand= "Titos", type="alchool", estimated_fill="100", image=None)
tequila = IngredientService.addIngredient(name="Tequila", pumpNumber=1, size= "1.75 L", ml=1750, brand= "Patron", type="alchool", estimated_fill="100", image=None)
spirte = IngredientService.addIngredient(name="Sprite", pumpNumber=2, size= "2 L", ml=2000, brand= "Sprite", type="mixer", estimated_fill="100", image=None)
clubSoda = IngredientService.addIngredient(name="Club Soda", pumpNumber=3, size= "2 L", ml=2000, brand= "Canada Dry", type="mixer", estimated_fill="100", image=None)
orangeJuice = IngredientService.addIngredient(name="Orange Juice", pumpNumber=4, size= "1 G", ml=3785, brand= "Minute Made", type="mixer", estimated_fill="100", image=None)
limeJuice = IngredientService.addIngredient(name="Lime Juice", pumpNumber=5, size= "1 Q", ml=1000, brand= "Real Lime", type="mixer", estimated_fill="100", image=None)
...
MenuService.addDrinkToMenu("Vodka and Lime", {vodka:50, limeJuice:100}, price=6.99, image=None, description="Vodka mixed with lime", menuFilePath=MenuService.defaultMenufilePath)
...
MenuService.addDrinkToMenu("Tequila and Lime", {tequila:50, limeJuice:100}, price=6.99, image=None, description="Tequila mixed with lime", menuFilePath=MenuService.defaultMenufilePath)